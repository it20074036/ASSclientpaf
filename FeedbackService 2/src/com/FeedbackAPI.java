...
public class FeedbackAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String result = appObj.insertFeedback(
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = appObj.updateFeedback(
				param.get("hidFeedbackIDSave").toString(),
				param.get("fName").toString().toString().replace("+", " "),     
				param.get("eMail").toString().toString().replace("%40", "@"), 
		 		param.get("feedBack").toString().toString().replace("+", " ") );
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = appObj.deleteFeedback(param.get("fID").toString());
